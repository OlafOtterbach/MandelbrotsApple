...
using MandelbrotsApple.Mandelbrot.Functions;
using MandelbrotsApple.Mandelbrot.Model;

public class MandelbrotValidationTest
{
    [Fact]
    public void Validate_Test_Parameter_is_null()
    {
        // Arrange
        MandelbrotParameter parameter = null;
        var errorList = new List<ValidationError>();

        // Act
        var result = MandelbrotValidation.Validate(parameter);
        result.Match(errs => errorList = errs.Cast<ValidationError>().ToList(), p => { });

        // Assert
        Assert.False(result.IsValid);
        Assert.Equal(ErrorType.ParameterIsNull, errorList[0].ErrorType);
    }
    ...
    public void Validate_Difference_Between_XMin_XMax_Test__Difference_exist()
    {
        ...
        // Act
        var result = MandelbrotValidation.Validate_Difference_Between_XMin_XMax(parameter);
    ...
    public void Validate_Difference_Between_YMin_YMax_Test__Difference_exist()
    {
        ...
        // Act
        var result = MandelbrotValidation.Validate_Difference_Between_YMin_YMax(parameter);
    ...
    public void Validate_XMin_ANd_XMax_Test__Min_greater_than_max()
    {
        ...
        // Act
        var result = MandelbrotValidation.Validate_XMin_ANd_XMax(parameter);
